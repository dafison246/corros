                ...
                <div class="steps-vertical">
                    <div class="step-wrap">
                        ...
                        <div class="step-wrap__title">
                            <h6>May</h6>
                            <h3 class="color-main thin">1999</h3>
                        </div>

                        <div class="step-wrap__image">
                            <img src="images/steps/01.jpg" alt="">
                        </div>
                    </div>
                    <div class="step-wrap">
                        <div class="step-wrap__text">
                        ...
                        <div class="step-wrap__title">
                            <h6>June</h6>
                            <h3 class="color-main thin">2005</h3>
                        </div>

                        <div class="step-wrap__image">
                            <img src="images/steps/02.jpg" alt="">
                        </div>
                    </div>
                    <div class="step-wrap">
                        <div class="step-wrap__text">
                        ...
                        <div class="step-wrap__title">
                            <h6>September</h6>
                            <h3 class="color-main thin">2008</h3>
                        </div>

                        <div class="step-wrap__image">
                            <img src="images/steps/03.jpg" alt="">
                        </div>
                    </div>
                    <div class="step-wrap">
                        <div class="step-wrap__text">
                        ...
                        <div class="step-wrap__title">
                            <h6>February</h6>
                            <h3 class="color-main thin">2015</h3>
                        </div>

                        <div class="step-wrap__image">
                            <img src="images/steps/04.jpg" alt="">
                        </div>
                    </div>
                    <div class="step-wrap">
                        <div class="step-wrap__text">
                        ...
                        <div class="step-wrap__title">
                            <h6>July</h6>
                            <h3 class="color-main thin">2019</h3>
                        </div>

                        <div class="step-wrap__image">
                            <img src="images/steps/05.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
