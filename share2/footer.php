			...
			<div class="col-lg-4 col-md-6 order-1 order-lg-1  animate" data-animation="fadeInUp">
				...
				<a href="/" class="logo">
					...
					<span class="d-flex flex-column">
						...
						<span class="logo-subtext">CORROSION ENGINEERING</span>
					</span>
				</a>
				<p>
					Our commitment to supplying the absolute highest performing products on the market are achieved through our dedication to utilizing only the finest-quality raw materials and technologies.
				</p>
				...
				<div class="widget widget_icons_list">
					<ul>
						...
						<li class="icon-inline">
							...
							<p><a href="#"><span class="__cf_email__" data-cfemail="4c222d2a382d0c29342d213c2029622f2321">[email&#160;protected]</span></a></p>
						</li>
						<li class="icon-inline">
							<div class="icon-styled icon-top bordered round  fs-16">
...
<!-- Mirrored from html.modernwebtemplates.com/nafta/footer1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Mar 2023 23:25:19 GMT -->
